...
// console.log(b);
        ...
        a = {...a,school : 'gcgsdc'}
        console.log(a);
// console.log(typeof a.name);  // typeof a.name là in ra giá trị của name là gì, có thể làn number, string...
...
// a.name = 'dai';
// a.age = 29;
// b[0].name = 'quye2'; // là sửa đổi vị trí thứ nhất, có giá trị name thành quye2
